...
std::unique_ptr<transform::Rigid2d> LocalTrajectoryBuilder2D::ScanMatch(
  ...
  ceres_scan_matcher_.Match(pose_prediction.translation(), initial_ceres_pose,  //ceres 扫描匹配
...
LocalTrajectoryBuilder2D::AddRangeData(     //收集传感器数据
...
LocalTrajectoryBuilder2D::AddAccumulatedRangeData(  //累计10桢激光数据
  ...
  std::unique_ptr<transform::Rigid2d> pose_estimate_2d =
      ScanMatch(time, pose_prediction, gravity_aligned_range_data); //ceres 扫描匹配
